...
{  
    ...
    {  
        ...
        if(current==1)  
        {  
            l.setText("Que2: Number of  non-primitive data types in java are?");  
            jb[0].setText("6");jb[1].setText("7");jb[2].setText("8");jb[3].setText("9");  
        }  
        if(current==2)  
        {  
            l.setText("Que3: Where is system package is defined?");  
            jb[0].setText("java.lang.package");jb[1].setText("java.util.package ");jb[2].setText("java.lo.package");jb[3].setText("None");  
        }  
        if(current==3)  
        {  
            l.setText("Que4: For exception handling which block is used.?");  
            jb[0].setText(" try and catch");jb[1].setText("throw");jb[2].setText("final");jb[3].setText("thrown");  
        }  
        if(current==4)  
        {  
        ...
        if(current==5)  
        {  
            l.setText("Que6: write full form of oops ?");  
            jb[0].setText("object oriented programming language");jb[1].setText("oriented object language");jb[2].setText("O.programming language");jb[3].setText("if(All of the above)");  
        }  
        if(current==6)  
        {  
